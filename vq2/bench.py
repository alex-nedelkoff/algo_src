...
def run_bench(root: str, policies=("radius", "huber")) -> dict:
    out = {}
...
def main(argv: list) -> int:
    if not argv:
        ...
        return 2
    root = argv[0]
    policies = tuple(argv[1:]) or ("radius", "huber")
    out = run_bench(root, policies)
    cols = ["accepted", "rejected", "anchor_p50", "anchor_p90",
            "nis_p50", "nis_frac_gt_gate", "dist_traveled_m"]
